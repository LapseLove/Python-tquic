...
impl Config {
    ...
    fn set_sqp_params(
        ...
        self.recovery.sqp_param_m = m;
        self.recovery.sqp_param_t = t;
        self.recovery.sqp_param_delta = delta;
        self.recovery.sqp_param_r = r;
    }

    fn set_sqp_frame_interval(&mut self, frame_interval: u64) {
        self.recovery.sqp_frame_interval = frame_interval;
    }

    fn set_sqp_init_pacing_rate(&mut self, pacing_rate: u64) {
        self.recovery.sqp_init_pacing_rate = pacing_rate;
    }
}
...
pub struct RecoveryConfig {
    ...
    // SQP Pacing multiplier, Default 2.0
    pub sqp_param_m: f64,

    // SQP Target multiplier, Default 0.9
    pub sqp_param_t: f64,

    // SQP Step size, Default 320 kbps
    pub sqp_param_delta: u64,

    // SQP Reward weight, Default 0.25
    pub sqp_param_r: f64,

    // SQP frame interval, frame per second, Default 30
    pub sqp_frame_interval: u64,

    // SQP initial pacing rate, in bps, Default 2 Mbps
    pub sqp_init_pacing_rate: u64,
}
...
impl Default for RecoveryConfig {
    fn default() -> RecoveryConfig {
        RecoveryConfig {
            ...
            sqp_param_m: 2.0,
            sqp_param_t: 0.9,
            sqp_param_delta: 320000,
            sqp_param_r: 0.25,
            sqp_frame_interval: 30,
            sqp_init_pacing_rate: 2000000,
        }
    }
}
